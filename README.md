...
- User-defined custom styles for sims and houses
	...
	- View the [Style Wiki](https://github.com/Sam-Chug/simnationfinder/wiki/Custom-Sim-Panel-Styles) for more information on building a style sequence for your sim or house
