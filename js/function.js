    ...
    function sortEntityList(entityType) {
        ...
        if (entityType == "sim") {
            ...
            if (simDataHolder.simSort == "age") {
                ...
                GUI_SORT_SIM_NAMES.style.background = `url(./images/buttons/name-sort-selected.png?v0.2.3j)`;
                ...
                GUI_SORT_SIM_NAMES.style.background = `url(./images/buttons/name-sort.png?v0.2.3j)`;
            ...
            if (simDataHolder.lotSort == "pop") {
                ...
                GUI_SORT_LOT_NAMES.style.background = `url(./images/buttons/name-sort-selected.png?v0.2.3j)`;
                ...
                GUI_SORT_LOT_NAMES.style.background = `url(./images/buttons/name-sort.png?v0.2.3j)`;
...
guiUtils = function() {
    ...
    function writeAbsentLotThumbnail(existence, selectedSimLong) {
        ...
        GUI_LOT_THUMBNAIL.src = "./images/unknown.png?v0.2.3j";
...
filterUtils = function() {
    ...
    function fillButtonGraphics() {
        ...
        for (let i = 0; i < 12; i++) {
            ...
            button.style.background = "url(./images/filter-spritesheets/lot-filter.png?v0.2.3j) " + -x + "px " + -y + "px";
        ...
        for (let i = 0; i < 12; i++) {
            ...
            var x = (i % 4) * 71;
            var y = Math.floor(i / 4) * 71;
            button.style.background = "url(./images/filter-spritesheets/sim-filter.png?v0.2.3j) " + -x + "px " + -y + "px";
    ...
    function mouseOverFilterChange(button, action, type) {
        ...
        if (type == "lot") {
            ...
            if (action == "in") {
                ...
                button.style.background = "url(./images/filter-spritesheets/lot-filter-hover.png?v0.2.3j) " + -x + "px " + -y + "px";
            }
            else if (action == "out") {
            ...
            if (action == "in") {
                ...
                button.style.background = "url(./images/filter-spritesheets/sim-filter-hover.png?v0.2.3j) " + -x + "px " + -y + "px";
            }
            else if (action == "out") {
    ...
    function filterButtonClick(button, type) {
        ...
        if (type == "lot") {
            ...
            if (sameButton) {
                ...
                var x = (index % 4) * 71;
                var y = Math.floor(index / 4) * 71;
                button.style.background = "url(./images/filter-spritesheets/lot-filter-selected.png?v0.2.3j) " + -x + "px " + -y + "px";
            ...
            if (sameButton) {
                ...
                var x = (index % 4) * 71;
                var y = Math.floor(index / 4) * 71;
                button.style.background = "url(./images/filter-spritesheets/sim-filter-selected.png?v0.2.3j) " + -x + "px " + -y + "px";
...
sidebarUtils = function() {
    ...
    function writeActiveJobs() {
        ...
        SIDEBAR_JOB_FACTORY.style.background = "url(./images/buttons/jobs-active.png?v0.2.3j) 40px 0";
        SIDEBAR_JOB_DINER.style.background = "url(./images/buttons/jobs-active.png?v0.2.3j) 40px 80px";
        SIDEBAR_JOB_CLUB.style.background = "url(./images/buttons/jobs-active.png?v0.2.3j) 40px 40px";

        // Set active jobs to active icon
        if (jobsActive.includes(1)) SIDEBAR_JOB_FACTORY.style.background = "url(./images/buttons/jobs-active.png?v0.2.3j) 0 0";
        if (jobsActive.includes(2)) SIDEBAR_JOB_DINER.style.background = "url(./images/buttons/jobs-active.png?v0.2.3j) 0 80px";
        if (jobsActive.includes(4)) SIDEBAR_JOB_CLUB.style.background = "url(./images/buttons/jobs-active.png?v0.2.3j) 0 40px";
    }
