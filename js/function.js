simUtils = function() {
    ...
    function returnShortSimFromLong(longSim) {
        ...
        // for if it breaks
        //console.log(simDataHolder.simShortList.avatars, longSim);
    ...
    function sortEntityList(entityType) {
        ...
        if (entityType == "sim") {
            ...
            if (simDataHolder.simSort == "age") {
                ...
                GUI_SORT_SIM_NAMES.style.background = `url(./images/buttons/name-sort-selected.png?v0.2.3g)`;
                ...
                GUI_SORT_SIM_NAMES.style.background = `url(./images/buttons/name-sort.png?v0.2.3g)`;
            ...
            if (simDataHolder.lotSort == "pop") {
                ...
                GUI_SORT_LOT_NAMES.style.background = `url(./images/buttons/name-sort-selected.png?v0.2.3g)`;
                ...
                GUI_SORT_LOT_NAMES.style.background = `url(./images/buttons/name-sort.png?v0.2.3g)`;
...
guiUtils = function() {
        ...
        if (type == "sim") {
            ...
            if (simUtils.isSimOnline(simName)) {
                ...
                if (!simUtils.checkIfSimInLongCache(simName)) {
                    ...
                    selectedSimLong = await apiUtils.getAPIData("https://web-production-3227.up.railway.app/http://simnationserver.com:9000/userapi/city/1/avatars/name/" + simName.replace(" ", "%20"));
    ...
    function writeAbsentLotThumbnail(existence, selectedSimLong) {
        ...
        GUI_LOT_THUMBNAIL.src = "./images/unknown.png?v0.2.3g";
    ...
    async function writeSimsInLot(selectedLot, population) {
        ...
        if (isTownHall) {
            ...
            // Get townhall object
            townhallObj = await apiUtils.getAPIData(`https://web-production-3227.up.railway.app/http://simnationserver.com:9000/userapi/neighborhoods/${selectedLot.neighborhood_id}`);

            // Get mayor
            if (townhallObj.mayor_id != null) {

                let avatarLong = await apiUtils.getAPIData(`https://web-production-3227.up.railway.app/http://simnationserver.com:9000/userapi/avatars?ids=${townhallObj.mayor_id}`);
...
filterUtils = function() {
    ...
    function fillButtonGraphics() {
        ...
        for (let i = 0; i < 12; i++) {
            ...
            button.style.background = "url(./images/filter-spritesheets/lot-filter.png?v0.2.3g) " + -x + "px " + -y + "px";
        ...
        for (let i = 0; i < 12; i++) {
            ...
            var x = (i % 4) * 71;
            var y = Math.floor(i / 4) * 71;
            button.style.background = "url(./images/filter-spritesheets/sim-filter.png?v0.2.3g) " + -x + "px " + -y + "px";
    ...
    function mouseOverFilterChange(button, action, type) {
        ...
        if (type == "lot") {
            ...
            if (action == "in") {
                ...
                button.style.background = "url(./images/filter-spritesheets/lot-filter-hover.png?v0.2.3g) " + -x + "px " + -y + "px";
            }
            else if (action == "out") {
            ...
            if (action == "in") {
                ...
                button.style.background = "url(./images/filter-spritesheets/sim-filter-hover.png?v0.2.3g) " + -x + "px " + -y + "px";
            }
            else if (action == "out") {
    ...
    function filterButtonClick(button, type) {
        ...
        if (type == "lot") {
            ...
            if (sameButton) {
                ...
                var x = (index % 4) * 71;
                var y = Math.floor(index / 4) * 71;
                button.style.background = "url(./images/filter-spritesheets/lot-filter-selected.png?v0.2.3g) " + -x + "px " + -y + "px";
            ...
            if (sameButton) {
                ...
                var x = (index % 4) * 71;
                var y = Math.floor(index / 4) * 71;
                button.style.background = "url(./images/filter-spritesheets/sim-filter-selected.png?v0.2.3g) " + -x + "px " + -y + "px";
...
searchUtils = function() {
    ...
    async function searchSim() {
        ...
        if (!simUtils.checkIfSimInLongCache(simName)) {
            ...
            simLong = await apiUtils.getAPIData("https://web-production-3227.up.railway.app/http://simnationserver.com:9000/userapi/city/1/avatars/name/" + simName.replace(" ", "%20"));
...
sidebarUtils = function() {
    ...
    function writeActiveJobs() {
        ...
        SIDEBAR_JOB_FACTORY.style.background = "url(./images/buttons/jobs-active.png?v0.2.3g) 40px 0";
        SIDEBAR_JOB_DINER.style.background = "url(./images/buttons/jobs-active.png?v0.2.3g) 40px 80px";
        SIDEBAR_JOB_CLUB.style.background = "url(./images/buttons/jobs-active.png?v0.2.3g) 40px 40px";

        // Set active jobs to active icon
        if (jobsActive.includes(1)) SIDEBAR_JOB_FACTORY.style.background = "url(./images/buttons/jobs-active.png?v0.2.3g) 0 0";
        if (jobsActive.includes(2)) SIDEBAR_JOB_DINER.style.background = "url(./images/buttons/jobs-active.png?v0.2.3g) 0 80px";
        if (jobsActive.includes(4)) SIDEBAR_JOB_CLUB.style.background = "url(./images/buttons/jobs-active.png?v0.2.3g) 0 40px";
    }
...
apiUtils = function() {
    ...
    function buildLongSimLinkFromID(idList) {
        ...
        let simIdString = "https://web-production-3227.up.railway.app/http://simnationserver.com:9000/userapi/avatars?ids=";
    ...
    function buildLongLotLink(lotList) {
        ...
        let lotIDString = "https://web-production-3227.up.railway.app/http://simnationserver.com:9000/userapi/lots?ids=";
    ...
    function buildRoommateLink(longLot) {
        ...
        let roommateIDString = "https://web-production-3227.up.railway.app/http://simnationserver.com:9000/userapi/avatars?ids=";
